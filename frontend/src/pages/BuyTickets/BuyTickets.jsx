        ...
        <div className="location-availability">
            ...
            <div className="ticket-form">
                ...
                <div className="adult">
                    ...
                    <input required type="text" className='adult-numbers' placeholder='Eg: 5' onChange={(e) => {setAdultVisitors(e.target.value)}}/>
                    <label htmlFor="Number of male">Number of male</label>
                    <input required type="text" placeholder='Eg: 2' onChange={(e) => {setNoOfMaleAdult(e.target.value)}}/>
                    <label htmlFor="Number of female">Number of female</label>
                    <input required type="text" placeholder='Eg: 2' onChange={(e) => {setNoOfFemaleAdult(e.target.value)}}/>
                </div>
                <div className="children">
                    <h2>Children Ticket</h2>
                    <label htmlFor="children">Total no of visitors</label>
                    <input required type="text" className='children-numbers' placeholder='Eg: 5' onChange={(e) => {setChildrenVisitors(e.target.value)}}/>
                    <label htmlFor="Number of male">Number of male</label>
                    <input required type="text" placeholder='Eg: 2' onChange={(e) => {setNoOfMaleChildren(e.target.value)}}/>
                    <label htmlFor="Number of female">Number of female</label>
                    <input required type="text" placeholder='Eg: 2' onChange={(e) => {setNoOfFemaleChildren(e.target.value)}}/>
                </div>
                <div className="calender-isForeigner-email-phone">
                    <div className="radio-btn">
                        <label htmlFor="Indian">Indian</label>
                        <input required type="radio" name="nationality" value="Indian" onChange={(e) => {setNationality(e.target.value)}} />
                        <label htmlFor="Foreigner">Foreigner</label>
                        <input required type="radio" name="nationality" value="Foreigner" 
                       onChange={(e) => {setNationality(e.target.value)}}/>
                    </div>
                    <div className="ifForeigner" style={isForeigner ? {display: 'flex'} : {display: 'none'}} >
                    <label htmlFor="country">Enter Country</label>
                    <input required type="text" value={country} placeholder='Eg: England' onChange={(e) => {setCountry(e.target.value)}}/>
                    </div>
                    ...
                    <input required type="email" placeholder='Eg: johndoe@gmail.com' onChange={(e) => {setEmail(e.target.value)}}/>
                    </div>
                    <div className="phone">
                    <label htmlFor="country">Enter Phone Number</label>
                    <input required type="text" placeholder='Eg: 226458859' onChange={(e) => {setPhone(e.target.value)}}/>
                    </div>
