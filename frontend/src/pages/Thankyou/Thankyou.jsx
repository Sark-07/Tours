    ...
    <div className="bg-black h-screen flex items-center justify-center w-full">
          <div className="bg-white p-6 px-10 rounded md:mx-auto">
            ...
            <div className="text-center">
                ...
                <p className="text-white-600 my-2">Thank you for completing your secure online payment.</p>
                ...
                <div className="py-10 text-center">
                    <Link to='/' className="px-12 bg-green-400 rounded hover:bg-green-400 text-black font-semibold py-3">
                        Home 
                   </Link>
                </div>
            </div>
